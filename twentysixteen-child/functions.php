...
function twentysixteen_child_custom_title( $title ){
    ...
    if( is_tax( 'location' ) ){
        ...
        return 'Articles concernant la localité ' . $location->name . ' - ' . get_bloginfo( 'name' );
    }
    ...
    # 404
    if( is_404() ){
        return 'Désolé, ce que vous recherchez ne se trouve malheureusement par - ' . get_bloginfo( 'name' );
    }
