...
/**
 * Add Random posts (Small 1) widget
 *
...
class twentysixteenchild_randomposts_small_one extends WP_Widget {

    public function __construct() {
        parent::__construct(
            # Base ID of your widget
            'twentysixteenchild_randomposts_small_one',

            # Widget name will appear in UI
            __( 'Random Posts (Small 1)', 'twentysixteen-child' ),

            # Widget description
            array(
                'classname'   => 'widget_twentysixteenchild_randomposts_small_one',
                'description' => __( 'Small Random Posts widget with featured images.', 'twentysixteen-child' ),
            )
        );
    }
...
function twentysixteenchild_randomposts_small_one_register() {
    register_widget( 'twentysixteenchild_randomposts_small_one' );
}

add_action( 'widgets_init', 'twentysixteenchild_randomposts_small_one_register' );
