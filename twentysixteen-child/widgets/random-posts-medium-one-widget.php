...
/**
 * Add Random posts (Medium 1) widget
 *
...
class twentysixteenchild_randomposts_medium_one extends WP_Widget {
    ...
    public function __construct() {
        parent::__construct(
            ...
            __( 'Random Posts (Medium 1)', 'twentysixteen-child' ),

            # Widget description
            array(
                'classname'   => 'widget_twentysixteenchild_randomposts_medium_one',
                'description' => __( 'Medium-sized Random Posts with featured image and excerpt.', 'twentysixteen-child' ),
            )
        );
    }
...
add_action( 'widgets_init', 'twentysixteenchild_randomposts_medium_one_register' );
