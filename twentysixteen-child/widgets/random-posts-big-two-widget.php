...
class twentysixteenchild_randomposts_big_two extends WP_Widget {

    public function __construct() {
        parent::__construct(
            # Base ID of your widget
            'twentysixteenchild_randomposts_big_two',

            # Widget name will appear in UI
            __( 'Random Posts (Big 2)', 'twentysixteen-child' ),

            # Widget description
            array(
                'classname'   => 'widget_twentysixteenchild_randomposts_big_two',
                'description' => __( 'Big Random Posts with featured image and a 2-column excerpt. Featured images must have a minimum size of 1200x800 pixel.', 'twentysixteen-child' ),
            )
        );
    }
    ...
    public function widget( $args, $instance ){
        ...
        $bigtwo_query = new WP_Query( $query_args );
...
function twentysixteenchild_randomposts_big_two_register(){
    register_widget( 'twentysixteenchild_randomposts_big_two' );
}

add_action( 'widgets_init', 'twentysixteenchild_randomposts_big_two_register' );
