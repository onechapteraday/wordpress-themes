...
class twentysixteenchild_randomposts_big_one extends WP_Widget {

    public function __construct() {
        parent::__construct(
            # Base ID of your widget
            'twentysixteenchild_randomposts_big_one',

            # Widget name will appear in UI
            __( 'Random Posts (Big 1)', 'twentysixteen-child' ),

            # Widget description
            array(
                'classname'   => 'widget_twentysixteenchild_randomposts_big_one',
                'description' => __( 'Big Random Posts with an overlay excerpt text. Featured images must have a minimum size of 1200x800 pixel.', 'twentysixteen-child' ),
            )
        );
    }
...
function twentysixteenchild_randomposts_big_one_register() {
    register_widget( 'twentysixteenchild_randomposts_big_one' );
}

add_action( 'widgets_init', 'twentysixteenchild_randomposts_big_one_register' );
